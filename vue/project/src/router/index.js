...
const routes = [
  ...
  // webpackChunkName 이 같으면 같은 파일로 합쳐짐(grouping 가능)
  {
  ...
  },
  {
    ...
    component: () =>
      import(/* webpackChunkName: "event", webpackPrefetch:true */ '../views/2_event/EventChangeView.vue')
  },
  {
    path: '/event/key',
    name: 'EventKeyView',
